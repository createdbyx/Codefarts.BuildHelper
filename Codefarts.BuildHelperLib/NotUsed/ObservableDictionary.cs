// <copyright file="ObservableDictionary.cs" company="Codefarts">
...
namespace Codefarts.BuildHelper
{
    ...
    public class ObservableDictionary<TKey, TValue> : IDictionary<TKey, TValue>, INotifyCollectionChanged, INotifyPropertyChanged, IDictionary
    {
        ...
        /// The property is set and the <see cref="System.Collections.IDictionary"/> object is read-only.-or- The property is set,
        /// <paramref name="key"/> does not exist in the collection, and the <see cref="System.Collections.IDictionary"/> has a fixed size.
        /// </exception>
        /// <exception cref="NotImplementedException">
        /// Not implemented.
        /// </exception>
        object IDictionary.this[object key]
        {
            get
            {
                var index = this.keysList.IndexOf((TKey)key);
                return this.valuesList[index];
            }

            set
            {
                this.Insert((TKey)key, (TValue)value, false);
            }
        }
        ...
        /// </param>
        /// <returns>
        /// true if item was successfully removed from the <see cref="ICollection{T}"/>; otherwise, false. This method also returns false if item is
        /// not found in the original <see cref="ICollection{T}"/>.
        /// </returns>
        ...
        /// <summary>
        /// Copies the elements of the <see cref="System.Collections.ICollection"/> to an <see cref="System.Array"/>, starting at a particular
        /// <see cref="System.Array"/> index.
        /// </summary>
        /// <param name="array">
        /// The one-dimensional <see cref="System.Array"/> that is the destination of the elements copied from
        /// <see cref="System.Collections.ICollection"/>. The <see cref="System.Array"/> must have zero-based indexing.
        /// </param>
        /// <param name="index">
        ...
        /// <paramref name="array"/> is multidimensional.-or- The number of elements in the source <see cref="System.Collections.ICollection"/> is
        /// greater than the available space from <paramref name="index"/> to the end of the destination <paramref name="array"/>.-or-The type of the
        /// source <see cref="System.Collections.ICollection"/> cannot be cast automatically to the type of the destination <paramref name="array"/>.
        /// </exception>
        /// <exception cref="NotImplementedException">
        /// Not implemented.
        /// </exception>
