...
namespace BuildHelperTests
{
    ...
    public class ConditionEquality
    {
        ...
        {
            this.goodConditionEquality = new XElement("condition", new XAttribute("value1", "Test"), new XAttribute("operator", "="),
                new XAttribute("value2", "Test"));
            this.goodConditionEqualityWithTrueIgnore = new XElement("condition", new XAttribute("value1", "Test"), new XAttribute("operator", "="),
                new XAttribute("value2", "Test"), new XAttribute("ignorecase", true));
            this.goodConditionEqualityWithFalseIgnore = new XElement("condition", new XAttribute("value1", "Test"), new XAttribute("operator", "="),
                new XAttribute("value2", "Test"), new XAttribute("ignorecase", false));
        ...
        [TestMethod]
        public void GoodButValuesDiffer_Equal_MissingIgnore()
        {
            var item = XElement.Parse("<condition value1=\"Zest\" operator=\"equals\" value2=\"Test\" />");
            var node = TestHelpers.BuildCommandNode(item, null);
            Assert.IsFalse(node.SatifiesCondition(this.varibles));
        }

        [TestMethod]
        public void GoodButValuesDiffer_EqualTo_MissingIgnore()
        {
            var item = XElement.Parse("<condition value1=\"Zest\" operator=\"equalto\" value2=\"Test\" />");
            var node = TestHelpers.BuildCommandNode(item, null);
            Assert.IsFalse(node.SatifiesCondition(this.varibles));
        }
